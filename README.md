...
1. Клонируйте репозиторий:
   [ссылка](https://github.com/kostya261/HomeWork_30/pull/6)
...
## Добавлено
Валидация, пагинация, тесты, документация, сервис платежей, рассылка писем пользователей с использованием
celery/ redis
